...
def fluoro_get_coordinates(fluoro):
    ...
    if number_of_blobs <= 1:
        all_ECoG_Coords = [[449, 625], [488, 573], [703, 431], [765, 414], [533, 525], [584, 485], [642, 454], [418, 682]]
    else:
    ...
    # Reformat to list of lists
    # lead_line = [point.tolist() for point in lead_line]
    ...
    # Reformat to list of lists
    # pin_tips = [point.tolist() for point in pin_tips]
